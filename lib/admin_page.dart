...
http
  ...
  Future<void> _fetchUsers() async {
    ...
    try {
      final res = await http.get(
        Uri.parse('http://dianaxyz-offc.hostingercloud.web.id:4278/listUsers?key=$sessionKey'),
      );
  ...
  Future<void> _deleteUser() async {
    ...
    try {
      final res = await http.get(
        Uri.parse('http://dianaxyz-offc.hostingercloud.web.id:4278/deleteUser?key=$sessionKey&username=$username'),
      );
      final data = jsonDecode(res.body);
  ...
  Future<void> _createAccount() async {
    ...
    try {
      final url = Uri.parse(
        'http://dianaxyz-offc.hostingercloud.web.id:4278/userAdd?key=$sessionKey&username=$username&password=$password&day=$day&role=$newUserRole',
      );
